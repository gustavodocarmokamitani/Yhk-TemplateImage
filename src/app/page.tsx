                ...
                >
                  {col.map((photo) => (
                    <motion.button
                      ...
                      className="group relative block w-full overflow-hidden rounded-lg bg-[#121212] text-left transition-shadow duration-500 hover:shadow-2xl hover:shadow-black/50"
                    >
                      <GradedImage
                        src={photo.thumbUrl}
                        alt={
